        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              AI-powered job search from your CV
            </p>
          </div>
          <button
        ...
        {showCreate && (
          <div className="mb-6 p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800">
            <form
              onSubmit={(e) => {
                e.preventDefault()
                createMutation.mutate({ name: name || 'My Profile' })
              }}
        ...
        {isLoading ? (
          ...
          <div className="space-y-3">
            {profilesList.map((p) => (
              ...
              >
                <Link to={`/profiles/${p.id}`} className="flex-1 min-w-0">
